...
stored in SQLite databases with the help of the RSQLite and DBI packages
[@rsqlite; @dbi].
...
shown in the table and visualized as follows(@fig-sale-frequency).
...
Handling these inconsistencies required tools like janitor to clean and
organize the dataset [@janitor].
